...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull Button btAccount,
      @NonNull Button btLogin, @NonNull EditText etLogin, @NonNull EditText etPw,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.bt_account;
      Button btAccount = ViewBindings.findChildViewById(rootView, id);
      if (btAccount == null) {
        break missingId;
      }
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, btAccount, btLogin, etLogin,
          etPw, imageView, main, tvId, tvLogin, tvPassword);
    }
